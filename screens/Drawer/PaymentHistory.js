    ...
    <ScrollView style={styles.container}>
      {payments.map(payment => (
        <View key={payment._id} style={styles.paymentContainer}>
          <Text style={styles.paymentText}><Text style={styles.span}>Payment ID:</Text> {payment._id}</Text>
          <Text style={styles.paymentText}>
          <Text style={styles.span}>Amount:</Text> {payment.payment_amount}
          </Text>
          <Text style={styles.paymentText}><Text style={styles.span}>Date:</Text> {new Date(payment.createdAt).toLocaleString()}</Text>
        </View>
      ))}
    </ScrollView>
  );
